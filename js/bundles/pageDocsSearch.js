    ...
    ie_open('div', null, null,
      ...
      ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
              'class', 'container-hybrid');
            $templateAlias3({action: '/guide/search.html', dataURL: (($$temp = opt_data.site.basePath) == null ? '' : $$temp) + '/site.json', path: '/guide/', placeholder: 'Search Guides'}, null, opt_ijData);
          ie_close('div');
        ie_close('div');
      ie_close('div');
    ie_close('div');
  };
  $templateAlias1(soy.$$assignDefaults({elementClasses: 'docs', content: param492}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
...
var _searchSoy = __webpack_require__(238);
