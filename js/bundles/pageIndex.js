...
function $render(opt_data, opt_ignored, opt_ijData) {
  ie_open('div', null, null,
    ...
    ie_open('main', null, null,
      ...
      ie_open('div', null, null,
          'class', 'docs');
        $templateAlias1({items: opt_data.site.topbar, style: 'topbar-light topbar-docs', logo: {text: opt_data.site.title, icon: 'icon-16-bookmark'}}, null, opt_ijData);
        $templateAlias2({section: opt_data.site.index.children['guide'], site: opt_data.site}, null, opt_ijData);
  ...
  ie_open('nav', null, null,
    ...
    ie_open('div', null, null,
      ...
      ie_open('div', null, null,
        ...
        $templateAlias1({dataURL: (($$temp = opt_data.site.basePath) == null ? '' : $$temp) + '/site.json', maxResults: 3, path: '/guide/', placeholder: 'Search Guides'}, null, opt_ijData);
      ie_close('div');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param161 = function() {
    ...
    $about(null, null, opt_ijData);
    $what(null, null, opt_ijData);
 ...
 * @suppress {checkTypes}
 */
function $about(opt_data, opt_ignored, opt_ijData) {
      ...
      ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('p');
              itext('For anyone who does not work directly with web development, concepts like front-end vs. back-end development can be challenging to wrap your head around. Pile on all of the frameworks, programming languages, APIs, and libraries that front-end developers use to build apps, and it can get very confusing.');
            ie_close('p');
            ie_open('p');
              itext('The good news? You do not have to write code to understand the basics of the development process. And knowing how to talk about development is helpful whether you are a copywriter, a hiring manager, a marketer for a tech-based startup, or a product manager planning an upcoming sprint for a new app.');
            ie_close('p');
            ie_open('a', null, null,
                'href', '/guide/',
                'class', 'btn btn-accent');
              itext('Let\'s learn about development!');
            ie_close('a');
          ie_close('div');
        ie_close('div');
      ie_close('div');
...
exports.about = $about;
if (goog.DEBUG) {
  $about.soyTemplateName = 'pageIndex.about';
}
 ...
 * @suppress {checkTypes}
 */
function $what(opt_data, opt_ignored, opt_ijData) {
  ie_open('div', null, null,
      'class', 'features');
    ie_open('div', null, null,
        'class', 'container');
      ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('h3', null, null,
              'class', 'feature-title');
            itext('What is front-end?');
          ie_close('h3');
          ie_open('div', null, null,
              'class', 'feature-description');
            ie_open('p');
              itext('The front-end, also called "client-side", is everything that happens in the browser. It is everything the users sees and interacts with.');
            ie_close('p');
            ie_open('img', null, null,
                'alt', 'front-end development',
                'src', '/images/front_end_dev.jpg',
                'width', '100%');
            ie_close('img');
            ie_open('p');
              itext('Front-end developers use HTML, CSS, and JavaScript to code the website and web app designs created by web designers. The code they write runs inside the user\u2019s browser (as opposed to a back-end developer, whose code runs on the web server).');
            ie_close('p');
            ie_open('p');
            ...
            ie_close('p');
            ie_open('p');
              itext('To help you get started, we have written some guides and tutorials that will cover the basis for what you need to know about this area of web development. You will become familiar with everything front-end in Liferay.');
            ie_close('p');
            ie_open('a', null, null,
                'href', '/guide/',
                'class', 'btn btn-accent');
...
exports.what = $what;
if (goog.DEBUG) {
  $what.soyTemplateName = 'pageIndex.what';
}
