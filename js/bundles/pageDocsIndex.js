      ...
      ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('p', null, null,
            ...
            itext('Start learning the basics of front-end technology and begin developing!');
          ie_close('p');
        ie_close('div');
      ie_close('div');
      ie_open('div', null, null,
          ...
          ie_open('form', null, null,
            ...
            ie_open('div', null, null,
              ...
              ie_open('div', null, null,
                ...
                ie_open('div', null, null,
                    'class', 'search');
                  $templateAlias3({dataURL: (($$temp = opt_data.site.basePath) == null ? '' : $$temp) + '/site.json', maxResults: 3, path: '/guide/', placeholder: 'Search Guides'}, null, opt_ijData);
                ie_close('div');
              ie_close('div');
            ie_close('div');
          ie_close('form');
      ...
      ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('section', null, null,
              ...
              ie_open('p', null, null,
                ...
                itext('Each one provides the base knowledge to begin using Liferay\'s front-end code and tooling.');
              ie_close('p');
            ie_close('section');
          ie_close('div');
        ie_close('div');
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('div', null, null,
                'class', 'row');
              var childIdList209 = opt_data.page.childIds;
              var childIdListLen209 = childIdList209.length;
              for (var childIdIndex209 = 0; childIdIndex209 < childIdListLen209; childIdIndex209++) {
                var childIdData209 = childIdList209[childIdIndex209];
                var topic__soy199 = opt_data.page.children[childIdData209];
                if (! topic__soy199.hidden) {
                  ie_open('div', null, null,
                      'class', 'col-md-8 col-md-offset-0 col-xs-14 col-xs-offset-1');
                    ie_open('a', null, null,
                        'class', 'topic radial-out',
                        'href', topic__soy199.url);
                      ie_open('div', null, null,
                          'class', 'topic-icon');
                        ie_void('span', null, null,
                            'class', 'icon-16-' + topic__soy199.icon);
                      ie_close('div');
                      ie_open('h3', null, null,
                          'class', 'topic-title');
                        var dyn12 = topic__soy199.title;
