      ...
      ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('div', null, null,
                'class', 'row');
              var childIdList486 = opt_data.page.childIds;
              var childIdListLen486 = childIdList486.length;
              for (var childIdIndex486 = 0; childIdIndex486 < childIdListLen486; childIdIndex486++) {
                var childIdData486 = childIdList486[childIdIndex486];
                var topic__soy476 = opt_data.page.children[childIdData486];
                if (! topic__soy476.hidden) {
                  ie_open('div', null, null,
                      'class', 'col-md-8 col-md-offset-0 col-xs-14 col-xs-offset-1');
                    ie_open('a', null, null,
                        'class', 'topic radial-out',
                        'href', topic__soy476.url);
                      ie_open('div', null, null,
                          'class', 'topic-icon');
                        ie_void('span', null, null,
                            'class', 'icon-16-' + topic__soy476.icon);
                      ie_close('div');
                      ie_open('h3', null, null,
                          'class', 'topic-title');
                        var dyn28 = topic__soy476.title;
